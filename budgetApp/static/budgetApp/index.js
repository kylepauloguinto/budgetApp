...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if(path === "budget"){
        ...
        .then(budget =>{
            ...
            budget.forEach(data => {
                ...
                atransaction.setAttribute('onClick',`budgetTransaction("${data.budgetName}",${data.id})`);
    ...
    if( path == 'editSchedule'){
        ...
        let transferRepeat = document.getElementById("transferRepeatEditHidden").value;
...
function searchExpensesIncome(){
    ...
    let subcategory = $("#subCategory").val() != "" ? $("#subCategory").val() : null ;
    let data = {
        year: year,
    ...
    .then(report =>{
        ...
        report.months.forEach(data => {
                ...
                a.setAttribute('onClick',`reportDisplay(${data},${year},${accountName},${category},'${subcategory}')`);
